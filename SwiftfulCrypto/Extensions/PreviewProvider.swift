...
/*
 This class is to be able to make use of a default CoinModel
 object so that we can use it in the Previews that require us
 to pass in a CoinModel object. We are doing this because
 an object of this type will be used in many Views. Therefore,
 to not create or initialize many CoinModel objects in the
 Previews that require it, we are creating one sample object to
 be reused where ever it is required.
 */
...
extension PreviewProvider {
    ...
    /*
     Usage: PreviewProvider.dev
     returns DeveloperPreview.instance
     */
...
class DeveloperPreview {
    ...
    //one single instance of this DeveloperPreview class...
    //also referred to as a singleton
